    ...
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul id="myDIV">
          ...
          <li class="lit"style = "left : 0px; "><a href="index.php#about">About Us</a></li>
          <li class="lit"style = "left : 21px; " ><a href="index.php#newservices">Services</a></li>
    


          <li class="nav-item dropdown" style = "left : -3px; margin-top: 1px;">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"></a>
                <div class="dropdown-menu" >
                    <a href="mobile-app.php" class="dropdown-item"style="color:#00458f">Mobile App Development</a>
                    <a href="business-intelligence.php" class="dropdown-item"style="color:#00458f">Business Intelligence</a>
                    <a href="digital-transformation.php" class="dropdown-item"style="color:#00458f">Digital Transformation</a>             
                    <a href="open-source.php" class="dropdown-item"style="color:#00458f">Open Source Technologies</a>                          
                    <a href="professional-services.php" class="dropdown-item"style="color:#00458f">Professional Services</a>        
                    <a href="product.php" class="dropdown-item"style="color:#00458f">Product Development</a>             
                </div>
            </li>
          ...
          <li class="lit"><a href="index.php#contact">Contact Us</a></li>
